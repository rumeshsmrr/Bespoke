...
const CartPage = () => {
	...
	// Fetch cart data inside useEffect
	useEffect(() => {
		if (!user) {
			navigate("/login");
		} else {
	...
	return (
		<div className="w-full p-8 mt-24">
			<div className="w-full flex justify-center gap-5 items-start">
				...
				{/* Cart Summary */}
				<div className="md:w-1/3 bg-secondary-200 p-6 rounded-xl gap-4">
					...
					<div className="flex flex-row justify-center">
						<button className="mt-4 px-6 py-2 w-54 border-secondary-100 border-[1.5px] text-secondary-100 rounded-lg hover:bg-primary hover:text-secondary-100">
							<PaymentGateway />
						</button>
					</div>
					...
					<button
						className="mt-4 px-6 py-2 w-[165px] bg-secondary-100 mx-2 text-white rounded-lg hover:bg-primary hover:text-secondary-100"
